This project prints \char`\"{}\+Hello World\char`\"{} in a new window using Qt. The project is originally developed for Linux OS and has been tested that it works on Mac\+OS X. \subsection*{Required Packages}
